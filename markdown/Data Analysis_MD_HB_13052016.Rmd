---
title: "Data Analysis_HB_13052016"
...
*According to two Kruskal Wallis Tests there is no treatment effect for men, and none for women.*
...
*Judging based on the robust logistic regression controlling for gender, contributing is significantly more likely for subjects seeing a default by a political source compared to the control group, i.e. seeing no intervention and source. Being femal significantly increases the likelihood to donate. When gender is included via an interaction term, gender is not significant anymore, neither is the interaction with the treatment variables.*
